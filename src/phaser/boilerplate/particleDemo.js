var PhaserGameObject = (function () {
    ...
    PhaserGameObject.prototype.init = function (el, parent, options) {
        ...
        function create() {
            ...
            var padding = 15;
            var header1 = phaserTexts.add({ name: 'header', font: 'gem', size: 18, default: 'Particle FX Demo' });
            phaserTexts.alignToTopCenter('header', 10);
            phaserGroup.layer(10).add(header1);
            var instructions = phaserTexts.add({ name: 'instructions', size: 14, font: 'gem', default: "Press [A] to add particles\nPress [B] to add rotating particles"
            });
        ...
        function preloadComplete() {
            ...
            var emitter2 = phaserMaster.let('emitter2', game.add.emitter(game, 0, 0, 100));
        ...
        function update() {
            ...
            var emitter2 = phaserMaster.get('emitter2');
