var PhaserGameObject = (function () {
    ...
    PhaserGameObject.prototype.init = function (el, parent, options) {
        ...
        function create() {
            ...
            var padding = 15;
            var header1 = phaserTexts.add({ name: 'header', font: 'gem', size: 18, default: 'Filter FX 2 Demo' });
            phaserTexts.alignToTopCenter('header', 10);
            phaserGroup.layer(10).add(header1);
            var instructions = phaserTexts.add({ name: 'instructions', size: 14, font: 'gem', default: "Trippy!" });
        ...
        function preloadComplete() {
            ...
            var sprite = phaserMaster.let('sprite', game.add.sprite(0, 0, 'texture'));
            ...
            var filter = phaserMaster.let('filter', new Phaser.Filter(game, customUniforms, fragmentSrc));
